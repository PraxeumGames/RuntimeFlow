...
namespace RuntimeFlow.Tests
{
    public sealed class RuntimeFlowGameRestartHandlerLoggerTests
    {
        ...
        public void Restart_WhenLoggerInjected_WritesRestartRequestLog()
        {
            ...
            Assert.That(
                logger.Messages,
                Has.Some.Matches<string>(message =>
                    message.Contains("Restart: create request. Reason: logger-test", StringComparison.Ordinal)));
        }
        ...
        public void Restart_WhenLoggerNotProvided_UsesNullLoggerFallbackWithoutThrowing()
        {
            ...
            Assert.That(() => handler.Restart("fallback-test", forceSave: false), Throws.Nothing);
        }
