...
public sealed class ScopeActivationRuntimeWiringTests
{
    ...
    public async Task InitializeAsync_WhenReinitialized_ExecutesLoadedScopeExitHooksAndClearsLoadedStates()
    {
        ...
        Assert.AreEqual(
            ...
            calls);
        Assert.AreEqual(ScopeLifecycleState.Disposed, pipeline.GetScopeState<TestSceneScope>());
        Assert.AreEqual(ScopeLifecycleState.Disposed, pipeline.GetScopeState<TestModuleScope>());
        Assert.AreEqual(ScopeLifecycleState.Disposed, pipeline.GetScopeState<AdditiveActivationModuleScope>());
    }
    ...
    private interface IAlphaSessionActivationService : ISessionInitializableService, ISessionScopeActivationService { }    private interface IBetaSessionActivationService : ISessionInitializableService, ISessionScopeActivationService { }    private interface IAlphaSceneActivationService : ISceneInitializableService, ISceneScopeActivationService { }    private interface IBetaSceneActivationService : ISceneInitializableService, ISceneScopeActivationService { }    private interface IAlphaModuleActivationService : IModuleInitializableService, IModuleScopeActivationService { }    private interface IBetaModuleActivationService : IModuleInitializableService, IModuleScopeActivationService { }    private interface IAlphaAdditiveModuleActivationService : IModuleInitializableService, IModuleScopeActivationService { }    private interface IBetaAdditiveModuleActivationService : IModuleInitializableService, IModuleScopeActivationService { }
