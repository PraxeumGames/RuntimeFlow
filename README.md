...
```
https://github.com/user/RuntimeFlow.git?path=com.praxeum.runtimeflow
```
...
{
  "dependencies": {
    "com.praxeum.runtimeflow": "https://github.com/user/RuntimeFlow.git?path=com.praxeum.runtimeflow"
  }
}
```
